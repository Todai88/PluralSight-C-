...
using static Library.StandardCatalog;
...
namespace OutputViewer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Concrete Class:          {0}", 
                (standardCatalog).Save());
            Console.WriteLine("(ISaveable)Catalog:      {0}",
                ((ISaveable)standardCatalog).Save());
            Console.WriteLine("(IPersistable)Catalog:   {0}",
                ((IPersistable)standardCatalog).Save());
