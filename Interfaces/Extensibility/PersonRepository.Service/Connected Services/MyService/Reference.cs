...
namespace PersonRepository.Service.MyService {
    ...
    public interface IPersonService {
        ...
        PersonRepository.Interface.Person GetPerson(int Id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPersonService/GetPerson", ReplyAction="http://tempuri.org/IPersonService/GetPersonResponse")]
        System.Threading.Tasks.Task<PersonRepository.Interface.Person> GetPersonAsync(int Id);
        ...
        void UpdatePerson(int Id, PersonRepository.Interface.Person updatedPerson);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPersonService/UpdatePerson", ReplyAction="http://tempuri.org/IPersonService/UpdatePersonResponse")]
        System.Threading.Tasks.Task UpdatePersonAsync(int Id, PersonRepository.Interface.Person updatedPerson);
    ...
    public partial class PersonServiceClient : System.ServiceModel.ClientBase<PersonRepository.Service.MyService.IPersonService>, PersonRepository.Service.MyService.IPersonService {
        ...
        public PersonRepository.Interface.Person GetPerson(int Id) {
            return base.Channel.GetPerson(Id);
        }
        
        public System.Threading.Tasks.Task<PersonRepository.Interface.Person> GetPersonAsync(int Id) {
        ...
        public void UpdatePerson(int Id, PersonRepository.Interface.Person updatedPerson) {
            base.Channel.UpdatePerson(Id, updatedPerson);
        }
        
        public System.Threading.Tasks.Task UpdatePersonAsync(int Id, PersonRepository.Interface.Person updatedPerson) {
            return base.Channel.UpdatePersonAsync(Id, updatedPerson);
        }
